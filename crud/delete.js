const DELETE = {
   ...
   * @param {String[]} conditions the array with the where conditions. The values of this array parameter can be an array or a string. If it is a string, nothing changes, but if it is an array, its values are understood as Array[0] = Array[1]
